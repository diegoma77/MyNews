...
public class ATLSearchArticlesAPIRequestAndFillArticlesForNotificationsTable extends AsyncTaskLoader<List<ArticlesSearchAPIObject>> {

    private List<String> listOfUrls;

    private DatabaseHelper dbH;

    public ATLSearchArticlesAPIRequestAndFillArticlesForNotificationsTable(Context context, List<String> listOfUrls) {
        super(context);
