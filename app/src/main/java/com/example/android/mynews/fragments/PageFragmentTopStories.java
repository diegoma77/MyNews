...
import com.example.android.mynews.asynctaskloaders.atlrequest.ATLRequestTopStoriesAPI;
...
public class PageFragmentTopStories extends android.support.v4.app.Fragment {
    ...
    private static final int LOADER_TOP_STORIES_API_REQUEST = 3;
    private static final int LOADER_READ_ARTICLES_DATABASE = 4;
